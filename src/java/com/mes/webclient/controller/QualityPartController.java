...
@Controller("QualityPartController")
@RequestMapping("/QualityPartController.sp")
public class QualityPartController extends BaseController
{
	@Autowired
	IMService imService;

	String tableName = "quality_part";
	/**
	 * 进入页面
	 */
	...
	public String toAddOrEdit(QualitypartVO qualitypartVO, Model model)
	{
		...
		return "im/qualitypart/addOrEdit";
	}
