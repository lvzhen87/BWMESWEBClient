...
$(document).ready(function() {
	...
	$("#edit").click(function() {
		$("#formSidebar").css("display", "inline");
		$("#demoContent").removeClass("col-md-12");
		$("#demoContent").addClass("col-md-10");
	...
	$("#devpreview").click(function() {
		...
		$("#demoContent").removeClass("col-md-10");
		$("#demoContent").addClass("col-md-12");
