(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<span class=\"glyphicon glyphicon-chevron-right\">&nbsp;</span> <span class=\"glyphicon glyphicon-question-sign\">&nbsp;</span>\n";
		newCode += "</div>\n";
	...
	$(document).off('click', '.sidebar .list-group-item');
