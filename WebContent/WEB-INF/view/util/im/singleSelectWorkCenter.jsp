...
<section class="panel">
	...
	<div class="panel-body">
		<form action="utility.sp?selectWorkCenter"
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" name="workCenterNumber"
							id="workCenterNumber" value="${vo.workCenterNumber}"></input>
					</div>
					<label class="col-sm-2 control-label col-lg-2 no-padding">工作中心名称:</label>
					<div class="col-sm-3">
...
function confirmSelectLot()
{
	...
	$.post("workcenter.sp?getWorkCenterByKey",{key:key},function(result){
    	...
    	$("#workCenterNumber").val(obj.workCenterNumber);
  	});
