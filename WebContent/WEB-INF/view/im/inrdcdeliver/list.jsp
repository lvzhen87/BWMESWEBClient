...
<script type="text/javascript" src="dataTables/media/im/inrdcdeliver.js"></script>
<!-- MAIN PAGE -->
<section class="panel">
	<div class="panel-body">
		<form id="inrdcdeliver" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-sm-2" style="width: 130px; padding-left: 240px;">
						<button id="confirm" class="btn btn-success" type="button"
							style="padding-left: 25px; padding-right: 25px;">发货确认</button>
					</div>
				</div>
			</div>
	</div>
...
$(document).ready(function() {
	...
	getInRDCDeliverDataByName(nowUser);
	}
});
/**相关事件代码begin by cxcat*/
$('#inrdcdelivertb_length').remove();
...
$('#confirm').click(function(){
	...
	if(batch_no){
		$.ajax({
			url:'inrdcdeliver.sp?save&batch_no='+batch_no+'&bill_no='+bill_no+'&username='+username,
		   type:'GET'
		}).done(function(){
			$('.odd').remove();
		});
