    ...
    <form id="pageform" class="form-horizontal adminex-form">
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-sm-2">
            <input class="form-control" id="vin" name="vin" type="text" value="${vo.vin}" style="width: 120px; ">
          </div>
   
          <label class="col-sm-2 control-label col-lg-2" style="width: 120px; ">质量门1</label>
          <div class="col-sm-1">
            <input class="form-control" name="qualityGate_1" type="text" value="${vo.qualityGate_1}">
          </div>
          
           <label class="col-sm-2 control-label col-lg-2" style="width: 120px; ">质量门2</label>
          <div class="col-sm-1">
            <input class="form-control" name="qualityGate_2" type="text" value="${vo.qualityGate_2}">
          </div>
          
          <label class="col-sm-2 control-label col-lg-2" style="width: 120px; ">责任属性</label>
          <div class="col-sm-2">
