...
<script type="text/javascript" src="dataTables/media/im/rdcreceive.js"></script>
<!-- MAIN PAGE -->
<section class="panel">
	<div class="panel-body">
		<form id="rdcreceive" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
...
$(document).ready(function() {
	...
	getRDCReceiveDataByName(nowUser);
	}
});
</script>
