      ...
      <div class="tab-content">
        <div class="tab-pane active" id="basic">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
           	<label class="col-lg-2 col-sm-3 control-label" for="responsibleParty">责任属性</label>
            <div class="col-lg-3">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3"  >
				<select name="repairOpinion" class="form-control input-sm" style="BACKGROUND-COLOR: #FFEFDB;" >
      ...
      <table class="table table-hover table-striped table-condensed" id="vartable" style="table-layout:fixed;">
        ...
        <div class="form-group-inline">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
            	<input class="form-control form_datetime" size="16" type="text" value="${vo.brandName}" name="brandName" id="brandName" />
				<!--  <input class="form-control" name="brandName" type="text" value="A"> -->
            </div>
          </div>
