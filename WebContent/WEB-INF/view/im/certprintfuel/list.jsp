...
<section class="panel">
	<div class="panel-body">
		<form id="certificate" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
<%-- 					<label class="col-sm-2 control-label col-lg-2" style="width: 120px; ">VIN:</label>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" name="carmodelcode"
							value="${vo.carmodelcode}"></input>
					</div>
...
<section class="panel">
	<header class="panel-heading" style="padding-left: 35px; padding-right: 35px; ">
    	燃油基础信息：
    	<span>
         	<a href="CertConfigFuelController.sp?toAddOrEdit" data-toggle="modal" data-backdrop="static"
