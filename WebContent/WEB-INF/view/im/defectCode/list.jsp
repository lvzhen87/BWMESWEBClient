...
<script type="text/javascript" src="dataTables/media/im/defectCode.js"></script>
<!-- MAIN PAGE -->
<section class="panel">
	<div class="panel-body">
		<form id="area" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
					<label class="col-sm-2 control-label col-lg-2" style="width: 100px; ">层级1:</label>
					<div class="col-sm-2">
						<input type="text" class="form-control" name="level1"
							value="${vo.level1}"></input>
					</div>
					
					<label class="col-sm-2 control-label col-lg-2" style="width: 100px; ">层级2:</label>
					<div class="col-sm-2">
...
<section class="panel">
	<header class="panel-heading">
    	质量缺陷
    	<span>
         	<a href="DefectCodeController.sp?toAddOrEdit" data-toggle="modal"
...
{
	$.post("DefectCodeController.sp?del",{key:key},function(result){
		if(eval(result)=="操作成功")
		{
    		getAreaData();
		}
