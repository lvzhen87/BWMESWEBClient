...
<script type="text/javascript" src="dataTables/media/im/qualityGate.js"></script>
<!-- MAIN PAGE -->
<section class="panel">
...
<section class="panel">
	<header class="panel-heading">
    	质量门
    	<span>
         	<a href="QualityGateController.sp?toAddOrEdit" data-toggle="modal" data-backdrop="static"
...
{
	$.post("QualityGateController.sp?del",{key:key},function(result){
		if(eval(result)=="操作成功")
		{
    		getWorkCenterData();
		}
