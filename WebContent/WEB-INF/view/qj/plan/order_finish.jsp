...
<script type="text/javascript" src="qj/js/order_finish.js"></script>
<!--pickers css-->
	...
	<div class="panel-body">
		<form id="order" class="form-horizontal adminex-form">
			<div class="form-group">
				<label class="col-lg-1 col-sm-1 control-label">VIN号:</label>
				<div class="col-lg-2 col-sm-2">
					<input type="text" class="form-control" name="orderNumber"></input>
				</div>
				<label class="col-lg-1 col-sm-1 control-label">CSN:</label>
				<div class="col-lg-2 col-sm-2">
					<input type="text" class="form-control" name="csn"></input>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-2 col-sm-2">
					<input type="text" class="form-control default-date-picker" name="planOfflineDateStart"></input>
				</div>
				<label class="col-lg-1 col-sm-1 control-label">下线结束日期:</label>
				<div class="col-lg-2 col-sm-2">
					<input type="text" class="form-control default-date-picker" name="planOfflineDateEnd"></input>
				</div>
