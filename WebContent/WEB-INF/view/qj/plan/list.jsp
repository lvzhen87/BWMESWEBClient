...
<section class="panel">
	<header class="panel-heading" style="padding-left: 35px; padding-right: 35px; ">
		...
		<span>
			<div class="form-group">
				<div class="col-lg-1">
				<a   href="<%=request.getContextPath() %>/exceltemplate/excel_plan07.xlsx" >模版下载</a>
				</div>
	...
	<!-- 
    	<span>
         	<a class="btn btn-success" type="button" href="javascript:loadpage('plan.sp?downloadPlan','计划接收')" style=" padding-left: 25px; padding-right: 25px; ">接收</a>
		</span>
		 -->
    	<span>
         	<a class="btn btn-success" type="button" href="javascript:;" onclick="decompose()" style=" padding-left: 25px; padding-right: 25px; ">分解</a>
		</span>
		
		<span>
         	<a class="btn btn-success" type="button" href="javascript:;" onclick="importObject()" style=" padding-left: 25px; padding-right: 25px; ">导入系统对象</a>
        
		</span>
		<span>
		 	<a class="btn btn-success" type="button" href="javascript:;" onclick="importUDTable()" style=" padding-left: 25px; padding-right: 25px; ">导入自定义表</a>
		</span>
...
function importObject(){
	...
	$.post("plan.sp?importObject");
}
function importUDTable(){

	$.post("plan.sp?importUDTable");
}
