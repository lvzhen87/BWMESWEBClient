...
<script type="text/javascript" src="qj/js/bom_excel.js"></script>
...
<section class="panel">
	<div class="panel-body">
		<form id="plan" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
					<label class="col-sm-2 control-label col-lg-2" style="width: 100px; ">订单号:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control"  id = "orderNum" name="orderNum"
							value="${vo.orderNum}"></input>
					</div>
					<label class="col-sm-2 control-label col-lg-2" style="width: 100px; ">零件号:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" id="partNum" name="partNum"
							value="${vo.partNum}"></input>
					</div>
	...
	<header class="panel-heading" style="padding-left: 35px; padding-right: 35px; ">
		...
		<span>
			<div class="form-group">
				<div class="col-lg-1">
				<a   href="<%=request.getContextPath() %>/exceltemplate/order_bom.xls" >模版下载</a>
				</div>
