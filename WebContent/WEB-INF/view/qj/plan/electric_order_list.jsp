...
<script type="text/javascript" src="qj/js/ele_order_excel.js"></script>
...
function ajaxFileUpload(rdkey) {
	 ...
	 if(uploadFilePath.trim() == ""){
	  ...
	  $.ajaxFileUpload({
	    url : "plan.sp?importExcelEleOrder",
	    secureuri : false,
		...
		<form id="plan" class="form-horizontal adminex-form">
			<div class="col-md-12">
				<div class="row">
					...
					<label class="col-sm-2 control-label col-lg-2" >电池包ID号:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" id="eleID" name="eleID"
							value="${vo.eleID}"></input>
					</div>
	...
	<header class="panel-heading" style="padding-left: 35px; padding-right: 35px; ">
		...
		<span>
			<div class="form-group">
				<div class="col-lg-1">
				<a   href="<%=request.getContextPath() %>/exceltemplate/ele_order.xlsx" >模版下载</a>
				</div>
